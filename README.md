...
# Mode d'emploi : 
## Début de la partie
1. Au départ, les pions sont disposé en diagonal sur un carré de 2 par 2 au millieu du plateau.
...
3. Il peut les capturer en ligne,en colonnes, en diagonale ou alors les 3 en même temps.
4. Lorsqu'un joueur n'a pas de possibilité de capturer des pions de couleurs opposée il est forcé de passé son tour.
...
2. Si aucun des 2 joueurs ne peuvent jouer alors le joueur avec le plus de pion et déclarer vaiqueur
